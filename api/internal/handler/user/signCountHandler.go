...
func SignCountHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SignCountReq
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := user.NewSignCountLogic(r.Context(), svcCtx)
		resp, err := l.SignCount(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
